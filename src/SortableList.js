...
export default class SortableList extends Component {
    ...
    _setOrderOnMove() {
        ...
        if (this._movingDirectionChanged) {
            ...
            this._prevSwapedRowIndex = null;
        }
        this._nextActiveRowIndex = activeRowIndex;
        ...
        if (rowUnderActiveKey !== activeRowKey && rowUnderActiveKey !== this._prevSwapedRowKey) {
            ...
            if (isNeighbours) {
                ...
                this._prevSwapedRowIndex = rowUnderActiveIndex;
            ...
            if (this.props.swapChecker && !this.props.swapChecker(this._rowOnMoveIndex, rowUnderActiveIndex)) {
                return;
            }
    ...
    _onReleaseRow = (rowKey) => {
        ...
        if (this.props.onReleaseRow) {
            this.props.onReleaseRow(rowKey, this._rowOnMoveIndex, this._nextActiveRowIndex);
        }
    };
